...
public class Finder {
    ...
    public String loadProperties() throws IOException {
        InputStream resourceAsStream = this.getClass().getResourceAsStream("grpc.properties");
        Properties properties = new Properties();
        properties.load(resourceAsStream);
        String packageName = (String) properties.get("base-package");
        return packageName;
    }
    ...
    public void classFinder() throws IOException {
        String packageName = loadProperties();
